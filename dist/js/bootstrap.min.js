...
var custom=function(e){function a(){e("#name").val(""),e("#email").val(""),e("#msg").val(""),grecaptcha.reset()}function t(){e(search).parent().removeClass("has-danger"),e(search).removeClass("form-control-danger")}function n(e){ga("send","event",{eventCategory:e,eventAction:"Click"})}e(document).ready(function(){function s(a,t){e.ajax({type:"GET",url:"../includes/paging/loadmore.php",data:"limit="+a+"&offset="+t,cache:!1,beforeSend:function(){g.text("Henter...")},success:function(e){p.hide().append(e).fadeIn(300),g.appendTo(p),""==e?g.html(""):g.html('<button class="btn btn-primary" type="button">Vis flere...</button>').show()},error:function(e,a,t){console.log(e.responseText)}})}var r=e("#search"),o=e("#clearSearch"),i=e("#goSearch"),l=e("#contactform"),c=e("#sendMail"),d=e(".feedback"),h=e("#navbarSideButton"),u=e("#navbarSide"),f=e(".overlay"),v=e("#menuItems").children().clone();u.prepend(v);var p=e("#defaultAssignments"),m=e("#searchAssignments"),g=e("#load"),b=3,k=0;s(b,k),g.click(function(){var e=g.find("button").attr("data-atr");"nodata"!=e&&(k=b+k,s(b,k))}),e("#navbarSideButton, #navbarSide, .overlay, .nav-link").click(function(){h.toggleClass("open"),u.toggleClass("reveal"),f.toggle()});var x=function(e,a,t){var n=e.outerHeight(),s=t.offset().top;a.scrollTop()>=s?(t.height(n),e.addClass("affix")):(e.removeClass("affix"),t.height("auto"))};e('[data-toggle="affix"]').each(function(){var a=e(this),t=e("<div></div>");a.before(t),e(window).on("scroll resize",function(){x(a,e(this),t)}),x(a,e(window),t)}),e('a[href*="#"]').not(".accordion").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=e(this.hash);if(a=a.length?a:e("[name="+this.hash.slice(1)+"]"),a.length)return e("html, body").animate({scrollTop:a.offset().top-50},500),!1}}),c.click(function(){var t=e(l).serialize(),n="../includes/mail/mail_ajax.php";e.ajax({type:"POST",url:n,beforeSend:function(){e(d).html('<div class="progress mb-4"><div class="progress-bar progress-bar-striped progress-bar-animated bg-info" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div></div>')},data:t}).done(function(t){e(d).removeClass("alert alert-danger"),e(d).addClass("alert alert-success"),e(d).text(t),a()}).fail(function(a){e(d).removeClass("alert alert-success"),e(d).addClass("alert alert-danger"),""!==a.responseText?e(d).text(a.responseText):e(d).text("Der er sket en fejl. Beskeden er ikke blevet sendt.")})}),l.on("hidden.bs.modal",function(){d.text("").removeClass("alert alert-danger alert-success"),a()}),i.click(function(a){n("Search button"),a.preventDefault();var s="../includes/search/searchAssignments.php",o=r.val();return""!=o?(e.ajax({type:"POST",url:s,data:{search:o},success:function(e){p.hide(),t(),m.html(e).show()},error:function(){m.html("Søgning kunne ikke udføres - prøv igen senere.").show()}}),!1):(m.html(""),p.show(),r.parent().addClass("has-danger"),r.addClass("form-control-danger"),void 0)}),r.keypress(function(e){var a=e.keyCode?e.keyCode:e.which;13!=a&&10!=a||i.click()}),o.click(function(){r.val(""),m.html(""),p.show(),t(),n("Clear button")}),e(".social-nav a").click(function(){var a=e(this).attr("title");a&&n(a)}),e("#stats").on("hide.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","0")}),e("#stats").on("show.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","1px solid rgba(0,0,0,0.125)"),n("Expanding statistics")})})}(jQuery);