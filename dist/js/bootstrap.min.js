...
var custom=function(e){e(document).ready(function(){function a(){e("#inputName").val(""),e("#inputEmail").val(""),e("#inputMessage").val(""),grecaptcha.reset()}var s=e("#menuItems").children().clone(),t=e("#navbarSide"),r=e(".overlay");t.prepend(s),e("#navbarSideButton").click(function(){t.addClass("reveal"),r.show()}),e("#navbarSide, .overlay, .nav-link").click(function(){t.removeClass("reveal"),r.hide()});var n=function(e,a,s){var t=e.outerHeight(),r=s.offset().top;a.scrollTop()>=r?(s.height(t),e.addClass("affix")):(e.removeClass("affix"),s.height("auto"))};e('[data-toggle="affix"]').each(function(){var a=e(this),s=e("<div></div>");a.before(s),e(window).on("scroll resize",function(){n(a,e(this),s)}),n(a,e(window),s)}),e('a[href*="#"]').not(".accordion").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=e(this.hash);if(a=a.length?a:e("[name="+this.hash.slice(1)+"]"),a.length)return e("html, body").animate({scrollTop:a.offset().top-50},500),!1}});var i=e("#contactform"),o=e(".feedback");e("#sendMail").click(function(){var s=e(i).serialize(),t="../includes/mail/mail_ajax.php";e.ajax({type:"POST",url:t,beforeSend:function(){e(o).html('<div class="progress mb-4"><div class="progress-bar progress-bar-striped progress-bar-animated bg-info" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div></div>')},data:s}).done(function(s){e(o).removeClass("alert alert-danger"),e(o).addClass("alert alert-success"),e(o).text(s),a()}).fail(function(a){e(o).removeClass("alert alert-success"),e(o).addClass("alert alert-danger"),""!==a.responseText?e(o).text(a.responseText):e(o).text("Der er sket en fejl. Beskeden er ikke blevet sendt.")})}),e("#contactForm").on("hidden.bs.modal",function(){e(".feedback").text("").removeClass("alert alert-danger alert-success"),a()}),e("#goSearch").click(function(a){a.preventDefault();var s=e("#defaultAssignments"),t=e("#searchAssignments"),r="../includes/search/searchAssignments.php",n=e("#search").val();return""!=n?(e.ajax({type:"POST",url:r,data:{search:n},success:function(e){s.hide(),t.html(e).show()},error:function(){t.html("Søgning kunne ikke udføres - prøv igen senere.").show()}}),!1):(t.html(""),void s.show())}),e("#search").keypress(function(a){13===a.which&&e("#goSearch").click()}),e("#stats").on("hide.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","0")}),e("#stats").on("show.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","1px solid rgba(0,0,0,0.125)")})})}(jQuery);