...
var custom=function(e){function a(e,a){var t=[location.protocol,"//",location.host,location.pathname].join(""),n=document.location.search,o=e+"="+a,s="?"+o;n&&(updateRegex=new RegExp("([?&])"+e+"[^&]*"),removeRegex=new RegExp("([?&])"+e+"=[^&;]+[&;]?"),"undefined"==typeof a||null==a||""==a?(s=n.replace(removeRegex,"$1"),s=s.replace(/[&;]$/,"")):s=null!==n.match(updateRegex)?n.replace(updateRegex,"$1"+o):n+"&"+o),window.history.replaceState({},"",t+s)}function t(){e("#name").val(""),e("#email").val(""),e("#msg").val(""),grecaptcha.reset()}function n(){e(search).parent().removeClass("has-danger"),e(search).removeClass("form-control-danger")}function o(e){ga("send","event",{eventCategory:e,eventAction:"Click"})}e(document).ready(function(){function s(a,t){e.ajax({type:"GET",url:"../includes/paging/loadmore.php",data:"limit="+a+"&offset="+t,cache:!1,beforeSend:function(){b.text("Henter...")},success:function(e){v.hide().append(e).fadeIn(300),b.appendTo(v),""==e?b.html(""):b.html('<button class="btn btn-primary" type="button">Vis flere...</button>').show()},error:function(e,a,t){console.log(e.responseText)}})}var r=e("#search"),i=e("#clearSearch"),l=e("#goSearch"),c=e("#contactform"),d=e("#sendMail"),h=e(".feedback"),u=e("#navbarSideButton"),f=e("#navbarSide"),p=e(".overlay"),m=e("#menuItems").children().clone();f.prepend(m);var v=e("#defaultAssignments"),g=e("#searchAssignments"),b=e("#load"),x=3,k=0;s(x,k),b.click(function(){var e=b.find("button").attr("data-atr");"nodata"!=e&&(k=x+k,s(x,k))}),e("#navbarSideButton, #navbarSide, .overlay, .nav-link").click(function(){u.toggleClass("open"),f.toggleClass("reveal"),p.toggle()});var C=function(e,a,t){var n=e.outerHeight(),o=t.offset().top;a.scrollTop()>=o?(t.height(n),e.addClass("affix")):(e.removeClass("affix"),t.height("auto"))};e('[data-toggle="affix"]').each(function(){var a=e(this),t=e("<div></div>");a.before(t),e(window).on("scroll resize",function(){C(a,e(this),t)}),C(a,e(window),t)}),e('a[href*="#"]').not(".accordion").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=e(this.hash);if(a=a.length?a:e("[name="+this.hash.slice(1)+"]"),a.length)return e("html, body").animate({scrollTop:a.offset().top-50},500),!1}}),d.click(function(){var a=e(c).serialize(),n="../includes/mail/mail_ajax.php";e.ajax({type:"POST",url:n,beforeSend:function(){e(h).html('<div class="progress mb-4"><div class="progress-bar progress-bar-striped progress-bar-animated bg-info" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div></div>')},data:a}).done(function(a){e(h).removeClass("alert alert-danger"),e(h).addClass("alert alert-success"),e(h).text(a),t(),o("Message sent")}).fail(function(a){e(h).removeClass("alert alert-success"),e(h).addClass("alert alert-danger"),""!==a.responseText?e(h).text(a.responseText):e(h).text("Der er sket en fejl. Beskeden er ikke blevet sendt.")})}),c.on("hidden.bs.modal",function(){h.text("").removeClass("alert alert-danger alert-success"),t()}),l.click(function(t){o("Search button"),t.preventDefault();var s="../includes/search/searchAssignments.php",i=r.val();return""!=i?(e.ajax({type:"POST",url:s,data:{search:i},success:function(e){v.hide(),n(),g.html(e).show(),a("q",encodeURIComponent(i))},error:function(){g.html("Søgning kunne ikke udføres - prøv igen senere.").show()}}),!1):(g.html(""),v.show(),r.parent().addClass("has-danger"),r.addClass("form-control-danger"),void 0)}),r.keypress(function(e){var a=e.keyCode?e.keyCode:e.which;13!=a&&10!=a||l.click()}),i.click(function(){r.val(""),g.html(""),v.show(),n(),o("Clear button")}),e(".social-nav a").click(function(){var a=e(this).attr("title");a&&o(a)}),e("#stats").on("hide.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","0")}),e("#stats").on("show.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","1px solid rgba(0,0,0,0.125)"),o("Expanding statistics")})})}(jQuery);