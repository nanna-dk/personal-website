...
var custom=function(a){a(document).ready(function(){var t=function(a,t,e){var o=a.outerHeight(),i=e.offset().top;t.scrollTop()>=i?(e.height(o),a.addClass("affix")):(a.removeClass("affix"),e.height("auto"))};a('[data-toggle="affix"]').each(function(){var e=a(this),o=a("<div></div>");e.before(o),a(window).on("scroll resize",function(){t(e,a(this),o)}),t(e,a(window),o)}),a(".navbar-nav a").click(function(){window.innerWidth<768&&a(".navbar-collapse").collapse("hide")}),a('a[href*="#"]:not([href="#"])').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var t=a(this.hash);if(t=t.length?t:a("[name="+this.hash.slice(1)+"]"),t.length)return a("html, body").animate({scrollTop:t.offset().top},500),!1}})})}(jQuery);