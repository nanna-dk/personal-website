...
var custom=function(e){function a(){e("#name").val(""),e("#email").val(""),e("#msg").val(""),grecaptcha.reset()}function n(){e(search).parent().removeClass("has-danger"),e(search).removeClass("form-control-danger")}function t(e){ga("send","event",{eventCategory:e,eventAction:"Click"})}e(document).ready(function(){var s=e("#search"),r=e("#clearSearch"),o=e("#goSearch"),i=e("#contactform"),l=e("#sendMail"),c=e(".feedback"),d=e("#navbarSideButton"),h=e("#navbarSide"),f=e(".overlay"),u=e("#menuItems").children().clone();h.prepend(u);var g=e("#defaultAssignments"),v=e("#searchAssignments");g.load("../includes/downloads/pagedAssignments.php"),g.on("click",".pagination .page-link",function(a){a.preventDefault(),t("Paging clicked");var n=e(this).attr("data-page");g.load("../includes/downloads/pagedAssignments.php",{page:n},function(){})}),e("#navbarSideButton, #navbarSide, .overlay, .nav-link").click(function(){d.toggleClass("open"),h.toggleClass("reveal"),f.toggle()});var p=function(e,a,n){var t=e.outerHeight(),s=n.offset().top;a.scrollTop()>=s?(n.height(t),e.addClass("affix")):(e.removeClass("affix"),n.height("auto"))};if(e('[data-toggle="affix"]').each(function(){var a=e(this),n=e("<div></div>");a.before(n),e(window).on("scroll resize",function(){p(a,e(this),n)}),p(a,e(window),n)}),e('a[href*="#"]').not(".accordion").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=e(this.hash);if(a=a.length?a:e("[name="+this.hash.slice(1)+"]"),a.length)return e("html, body").animate({scrollTop:a.offset().top-50},500),!1}}),l.click(function(){var n=e(i).serialize(),t="../includes/mail/mail_ajax.php";e.ajax({type:"POST",url:t,beforeSend:function(){e(c).html('<div class="progress mb-4"><div class="progress-bar progress-bar-striped progress-bar-animated bg-info" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div></div>')},data:n}).done(function(n){e(c).removeClass("alert alert-danger"),e(c).addClass("alert alert-success"),e(c).text(n),a()}).fail(function(a){e(c).removeClass("alert alert-success"),e(c).addClass("alert alert-danger"),""!==a.responseText?e(c).text(a.responseText):e(c).text("Der er sket en fejl. Beskeden er ikke blevet sendt.")})}),i.on("hidden.bs.modal",function(){c.text("").removeClass("alert alert-danger alert-success"),a()}),o.click(function(a){t("Search button"),a.preventDefault();var r="../includes/search/searchAssignments.php",o=s.val();return""!=o?(e.ajax({type:"POST",url:r,data:{search:o},success:function(e){g.hide(),n(),v.html(e).show()},error:function(){v.html("Søgning kunne ikke udføres - prøv igen senere.").show()}}),!1):(v.html(""),g.show(),s.parent().addClass("has-danger"),s.addClass("form-control-danger"),void 0)}),s.keypress(function(e){var a=e.keyCode?e.keyCode:e.which;13!=a&&10!=a||o.click()}),r.click(function(){s.val(""),v.html(""),g.show(),n(),t("Clear button")}),e(".social-nav a").click(function(){var a=e(this).attr("title");a&&t(a)}),e("#stats").on("hide.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","0")}),e("#stats").on("show.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","1px solid rgba(0,0,0,0.125)"),t("Expanding statistics")}),window.performance){var m=Math.round(performance.now());ga("send","timing","JS dependencies","load",m)}})}(jQuery);