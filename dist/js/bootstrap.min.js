...
var custom=function(e){e(document).ready(function(){function a(){e("#inputName").val(""),e("#inputEmail").val(""),e("#inputMessage").val(""),grecaptcha.reset()}var t=function(e,a,t){var s=e.outerHeight(),n=t.offset().top;a.scrollTop()>=n?(t.height(s),e.addClass("affix")):(e.removeClass("affix"),t.height("auto"))};e('[data-toggle="affix"]').each(function(){var a=e(this),s=e("<div></div>");a.before(s),e(window).on("scroll resize",function(){t(a,e(this),s)}),t(a,e(window),s)}),e('a[href*="#"]').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=e(this.hash);if(a=a.length?a:e("[name="+this.hash.slice(1)+"]"),a.length)return e("html, body").animate({scrollTop:a.offset().top-50},500),!1}});var s=e("#contactform"),n=e(".feedback");e("#buttonid").click(function(){var t=e(s).serialize(),r="../includes/mail/mail_ajax.php";e.ajax({type:"POST",url:r,data:t}).done(function(t){e(n).removeClass("alert alert-danger"),e(n).addClass("alert alert-success"),e(n).text(t),a()}).fail(function(a){e(n).removeClass("alert alert-success"),e(n).addClass("alert alert-danger"),""!==a.responseText?e(n).text(a.responseText):e(n).text("Der er sket en fejl. Beskeden er ikke blevet sendt.")})}),e("#modalForm").on("hidden.bs.modal",function(){e(".feedback").text("").removeClass("alert alert-danger alert-success"),a()}),e("#go").click(function(a){a.preventDefault();var t=e("#defaultAssignments"),s=e("#searchAssignments"),n="../includes/search/searchAssignments.php",r=e("#search").val();return""!=r?(e.ajax({type:"POST",url:n,data:{search:r},success:function(e){t.hide(),s.html(e).show()},error:function(){s.html("Søgning kunne ikke foretages - prøv igen senere.").show()}}),!1):(s.html(""),void t.show())})})}(jQuery);