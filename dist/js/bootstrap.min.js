...
var custom=function(e){function a(){e("#name").val(""),e("#email").val(""),e("#msg").val(""),grecaptcha.reset()}function t(e){ga("send","event",{eventCategory:e,eventAction:"Click"})}e(document).ready(function(){var n=e("#search"),s=e("#clearSearch"),r=e("#goSearch"),o=e("#contactform"),i=e("#sendMail"),l=e(".feedback"),c=e("#navbarSideButton"),d=e("#navbarSide"),h=e(".overlay"),u=e("#menuItems").children().clone();d.prepend(u),e("#navbarSideButton, #navbarSide, .overlay, .nav-link").click(function(){c.toggleClass("open"),d.toggleClass("reveal"),h.toggle()});var f=function(e,a,t){var n=e.outerHeight(),s=t.offset().top;a.scrollTop()>=s?(t.height(n),e.addClass("affix")):(e.removeClass("affix"),t.height("auto"))};e('[data-toggle="affix"]').each(function(){var a=e(this),t=e("<div></div>");a.before(t),e(window).on("scroll resize",function(){f(a,e(this),t)}),f(a,e(window),t)}),e('a[href*="#"]').not(".accordion").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=e(this.hash);if(a=a.length?a:e("[name="+this.hash.slice(1)+"]"),a.length)return e("html, body").animate({scrollTop:a.offset().top-50},500),!1}}),i.click(function(){var t=e(o).serialize(),n="../includes/mail/mail_ajax.php";e.ajax({type:"POST",url:n,beforeSend:function(){e(l).html('<div class="progress mb-4"><div class="progress-bar progress-bar-striped progress-bar-animated bg-info" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div></div>')},data:t}).done(function(t){e(l).removeClass("alert alert-danger"),e(l).addClass("alert alert-success"),e(l).text(t),a()}).fail(function(a){e(l).removeClass("alert alert-success"),e(l).addClass("alert alert-danger"),""!==a.responseText?e(l).text(a.responseText):e(l).text("Der er sket en fejl. Beskeden er ikke blevet sendt.")})}),o.on("hidden.bs.modal",function(){l.text("").removeClass("alert alert-danger alert-success"),a()}),r.click(function(a){t("Search button"),a.preventDefault();var s=e("#defaultAssignments"),r=e("#searchAssignments"),o="../includes/search/searchAssignments.php",i=n.val();return""!=i?(e.ajax({type:"POST",url:o,data:{search:i},success:function(e){s.hide(),r.html(e).show()},error:function(){r.html("Søgning kunne ikke udføres - prøv igen senere.").show()}}),!1):(r.html(""),void s.show())}),n.keypress(function(e){var a=e.keyCode?e.keyCode:e.which;13!=a&&10!=a||r.click()}),s.click(function(){n.val(""),t("Clear button")}),e("#stats").on("hide.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","0")}),e("#stats").on("show.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","1px solid rgba(0,0,0,0.125)"),t("Expanding statistics")})})}(jQuery);