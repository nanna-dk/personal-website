function _classCallCheck(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var _createClass=function(){function e(e,t){for(var n=0;n<t.length;n++){var a=t[n];a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}return function(t,n,a){return n&&e(t.prototype,n),a&&e(t,a),t}}(),Button=function(e){var t="button",n="4.0.0-alpha.6",a="bs.button",s="."+a,r=".data-api",o=e.fn[t],l={ACTIVE:"active",BUTTON:"btn",FOCUS:"focus"},i={DATA_TOGGLE_CARROT:'[data-toggle^="button"]',DATA_TOGGLE:'[data-toggle="buttons"]',INPUT:"input",ACTIVE:".active",BUTTON:".btn"},c={CLICK_DATA_API:"click"+s+r,FOCUS_BLUR_DATA_API:"focus"+s+r+" "+("blur"+s+r)},u=function(){function t(e){_classCallCheck(this,t),this._element=e}return t.prototype.toggle=function(){var t=!0,n=e(this._element).closest(i.DATA_TOGGLE)[0];if(n){var a=e(this._element).find(i.INPUT)[0];if(a){if("radio"===a.type)if(a.checked&&e(this._element).hasClass(l.ACTIVE))t=!1;else{var s=e(n).find(i.ACTIVE)[0];s&&e(s).removeClass(l.ACTIVE)}t&&(a.checked=!e(this._element).hasClass(l.ACTIVE),e(a).trigger("change")),a.focus()}}this._element.setAttribute("aria-pressed",!e(this._element).hasClass(l.ACTIVE)),t&&e(this._element).toggleClass(l.ACTIVE)},t.prototype.dispose=function(){e.removeData(this._element,a),this._element=null},t._jQueryInterface=function(n){return this.each(function(){var s=e(this).data(a);s||(s=new t(this),e(this).data(a,s)),"toggle"===n&&s[n]()})},_createClass(t,null,[{key:"VERSION",get:function(){return n}}]),t}();return e(document).on(c.CLICK_DATA_API,i.DATA_TOGGLE_CARROT,function(t){t.preventDefault();var n=t.target;e(n).hasClass(l.BUTTON)||(n=e(n).closest(i.BUTTON)),u._jQueryInterface.call(e(n),"toggle")}).on(c.FOCUS_BLUR_DATA_API,i.DATA_TOGGLE_CARROT,function(t){var n=e(t.target).closest(i.BUTTON)[0];e(n).toggleClass(l.FOCUS,/^focus(in)?$/.test(t.type))}),e.fn[t]=u._jQueryInterface,e.fn[t].Constructor=u,e.fn[t].noConflict=function(){return e.fn[t]=o,u._jQueryInterface},u}(jQuery);
...
var custom=function(e){function a(e,a){var t=[location.protocol,"//",location.host,location.pathname].join(""),n=document.location.search,o=e+"="+encodeURIComponent(a),r="?"+encodeURIComponent(o);n&&(updateRegex=new RegExp("([?&])"+e+"[^&]*"),removeRegex=new RegExp("([?&])"+e+"=[^&;]+[&;]?"),"undefined"==typeof a||null==a||""==a?(r=n.replace(removeRegex,"$1"),r=r.replace(/[&;]$/,"")):r=null!==n.match(updateRegex)?n.replace(updateRegex,"$1"+o):n+"&"+o),window.history.replaceState({},"",t+r)}function t(){e("#name").val(""),e("#email").val(""),e("#msg").val(""),grecaptcha.reset()}function n(){e(search).parent().removeClass("has-danger"),e(search).removeClass("form-control-danger")}function o(e){ga("send","event",{eventCategory:e,eventAction:"Click"})}e(document).ready(function(){function r(a,t){e.ajax({type:"GET",url:"../includes/paging/loadmore.php",data:"limit="+a+"&offset="+t,cache:!1,beforeSend:function(){b.text("Henter...")},success:function(e){v.hide().append(e).fadeIn(300),b.appendTo(v),""==e?b.html(""):b.html('<button class="btn btn-primary" type="button">Vis flere...</button>').show()},error:function(e,a,t){console.log(e.responseText)}})}var s=e("#search"),i=e("#clearSearch"),l=e("#goSearch"),c=e("#contactform"),d=e("#sendMail"),h=e(".feedback"),u=e("#navbarSideButton"),f=e("#navbarSide"),p=e(".overlay"),m=e("#menuItems").children().clone();f.prepend(m);var v=e("#defaultAssignments"),g=e("#searchAssignments"),b=e("#load"),x=3,k=0;r(x,k),b.click(function(){var e=b.find("button").attr("data-atr");"nodata"!=e&&(k=x+k,r(x,k))}),e("#navbarSideButton, #navbarSide, .overlay, .nav-link").click(function(){u.toggleClass("open"),f.toggleClass("reveal"),p.toggle()});var C=function(e,a,t){var n=e.outerHeight(),o=t.offset().top;a.scrollTop()>=o?(t.height(n),e.addClass("affix")):(e.removeClass("affix"),t.height("auto"))};e('[data-toggle="affix"]').each(function(){var a=e(this),t=e("<div></div>");a.before(t),e(window).on("scroll resize",function(){C(a,e(this),t)}),C(a,e(window),t)}),e('a[href*="#"]').not(".accordion").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=e(this.hash);if(a=a.length?a:e("[name="+this.hash.slice(1)+"]"),a.length)return e("html, body").animate({scrollTop:a.offset().top-50},500),!1}}),d.click(function(){var a=e(c).serialize(),n="../includes/mail/mail_ajax.php";e.ajax({type:"POST",url:n,beforeSend:function(){e(h).html('<div class="progress mb-4"><div class="progress-bar progress-bar-striped progress-bar-animated bg-info" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div></div>')},data:a}).done(function(a){e(h).removeClass("alert alert-danger"),e(h).addClass("alert alert-success"),e(h).text(a),t()}).fail(function(a){e(h).removeClass("alert alert-success"),e(h).addClass("alert alert-danger"),""!==a.responseText?e(h).text(a.responseText):e(h).text("Der er sket en fejl. Beskeden er ikke blevet sendt.")})}),c.on("hidden.bs.modal",function(){h.text("").removeClass("alert alert-danger alert-success"),t()}),l.click(function(t){o("Search button"),t.preventDefault();var r="../includes/search/searchAssignments.php",i=s.val();return""!=i?(e.ajax({type:"POST",url:r,data:{search:i},success:function(e){v.hide(),n(),g.html(e).show(),a("q",i)},error:function(){g.html("Søgning kunne ikke udføres - prøv igen senere.").show()}}),!1):(g.html(""),v.show(),s.parent().addClass("has-danger"),s.addClass("form-control-danger"),void 0)}),s.keypress(function(e){var a=e.keyCode?e.keyCode:e.which;13!=a&&10!=a||l.click()}),i.click(function(){s.val(""),g.html(""),v.show(),n(),o("Clear button")}),e(".social-nav a").click(function(){var a=e(this).attr("title");a&&o(a)}),e("#stats").on("hide.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","0")}),e("#stats").on("show.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","1px solid rgba(0,0,0,0.125)"),o("Expanding statistics")})})}(jQuery);