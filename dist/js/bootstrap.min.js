...
jQuery(document).ready(function(r){var e=r("#search"),t=r("#clearSearch"),a=r("#goSearch"),s=r("#contactform"),n=r("#sendMail"),o=r(".feedback"),c=r("#defaultAssignments"),l=r("#searchAssignments"),i=r(".sorting"),d=(r("#global-nav").outerHeight(!0),r(".scrolltop")),u=r('[data-toggle="offcanvas"]'),g={toggleNav:function(){r(".offcanvas-collapse").toggleClass("open"),d.toggleClass("d-none")},scrollToTop:function(){return r("html, body").animate({scrollTop:0},500),!1},scroll:function(){d&&(60<document.body.scrollTop||60<document.documentElement.scrollTop?d.addClass("show"):d.removeClass("show"))},urlParam:function(e){var t=new RegExp("[?&]"+e+"=([^]*)").exec(window.location.href);return null==t?null:t[1]||0},searchDb:function(){var t=e.val();if(t=g.strip_html_tags(t))return e.val(g.strip_html_tags(t)),r.ajax({type:"post",url:"includes/search/searchAssignments.php",data:{search:t},success:function(e){c.hide(),g.clearErrors(),l.hide().html(e).fadeIn(600),g.addParams("q",encodeURIComponent(t)),g.setRatings()},error:function(e,t,a){l.html("Søgning kunne ikke udføres - prøv igen senere.").show(),console.log(e.responseText)}}),!1;l.html(""),c.show(),e.addClass("is-invalid")},sortAssignments:function(e){var a=r(e.currentTarget),s=a.parent().siblings().find("a"),t=a.data("id").split("-"),n=t[0],o=t[1];r.ajax({url:"includes/downloads/sorting.php",type:"post",data:{column:n,sortOrder:o},success:function(e){a.removeClass("asc desc"),s.removeClass("asc desc"),s.attr("title","Sortér");var t=a.text().toLowerCase().trim();"asc"==o?(a.data("id",n+"-desc"),a.attr("title","Sortér "+t+" stigende"),a.addClass("desc")):(a.data("id",n+"-asc"),a.attr("title","Sortér "+t+" faldende"),a.addClass("asc")),c.empty(),c.hide().append(e).fadeIn(600),g.setRatings()},error:function(e,t,a){console.log(e.responseText)}})},setRatings:function(){r(".ratings").each(function(){var e=r(this).attr("data-avg");e=20*Number(e),r(this).find(".bg").css("width",0),r(this).find(".bg").animate({width:e+"%"},500)})},rate:function(){var n=r(this).closest(".ratings").attr("data-id"),o=r(this).attr("data-vote");0==-1<document.cookie.indexOf("Rating")?r.ajax({url:"includes/rating/vote.php",type:"POST",dataType:"json",data:{vote:"yes",item:n,point:o},success:function(e){var t=r(".ratings[data-id='"+n+"']");t.attr("data-avg",e.average);var a=e.average;a=20*Number(a),t.find(".bg").css("width",0),t.find(".bg").animate({width:a+"%"},500);var s=1==e.votes?"bedømmelse":"bedømmelser";t.find(".votes").html(e.votes+" "+s),g.trackThis("Rated assignment no. "+n+" with "+o)},error:function(e,t,a){console.log(e.responseText)}}):r(this).closest(".ratings").find(".votes").html("Du har allerede afgivet en bedømmelse - vend tilbage senere.")},strip_html_tags:function(e){return null!==e&&""!==e&&(e=e.toString()).replace(/<\/?[^>]+(>|$)/g,"")},addParams:function(e,t){var a=[location.protocol,"//",location.host,location.pathname].join(""),s=document.location.search,n=e+"="+t,o="?"+n;s&&(updateRegex=new RegExp("([?&])"+e+"[^&]*"),removeRegex=new RegExp("([?&])"+e+"=[^&;]+[&;]?"),o=void 0===t||null==t||""==t?(o=s.replace(removeRegex,"$1")).replace(/[&;]$/,""):null!==s.match(updateRegex)?s.replace(updateRegex,"$1"+n):s+"&"+n),window.history.replaceState({},"",a+o)},sendMsg:function(){var e=r(s).serialize();r.ajax({type:"post",url:"includes/mail/mail_ajax.php",beforeSend:function(){r(o).html('<div class="p-2 mb-4">Vent venligst...</div>')},data:e}).done(function(e){r(o).removeClass("alert alert-danger"),r(o).addClass("alert alert-success"),r(o).text(e),g.clearInput(),g.trackThis("Message sent")}).fail(function(e){r(o).removeClass("alert alert-success"),r(o).addClass("alert alert-danger"),""!==e.responseText?r(o).text(e.responseText):r(o).text("Der er sket en fejl. Beskeden er ikke blevet sendt.")})},clearInput:function(){r("#name").val(""),r("#email").val(""),r("#msg").val(""),grecaptcha.reset()},clearErrors:function(){r(e).removeClass("is-invalid")},trackThis:function(e){e&&gtag("event",e)}},m=g.urlParam("q");m&&(r(e).val(decodeURIComponent(g.strip_html_tags(m))),g.trackThis("Search"),r("html, body").animate({scrollTop:l.offset().top},500),g.searchDb()),g.setRatings(),g.scroll(),u.on("click",function(){g.toggleNav()}),r(".offcanvas-collapse .nav-link").on("click",function(){u.click()}),r(".utility-icons .nav-item a").click(function(){var e=r(this).attr("title");e&&g.trackThis(e)}),a.click(function(e){e.preventDefault(),g.trackThis("Search"),g.searchDb()}),t.click(function(){e.val(""),l.html(""),c.show(),g.clearErrors(),g.addParams("q",""),g.trackThis("Clear button")}),e.keypress(function(e){var t=e.keyCode?e.keyCode:e.which;13!=t&&10!=t||a.click()}),i.click(function(e){e.preventDefault(),g.sortAssignments(e),g.trackThis("Sort")}),r(document).on("mouseover",".star",function(){r(this).prevAll().addBack().addClass("full")}),r(document).on("mouseout",".star",function(){r(this).removeClass("full")}),r(document).on("click",".star",function(){g.rate()}),n.click(function(){g.sendMsg()}),s.on("hidden.bs.modal",function(){o.text("").removeClass("alert alert-danger alert-success"),g.clearInput()}),r("#cd-cover").on("show.bs.modal",function(e){r("#cover").attr("src","img/it-cover.jpg")}),d.click(function(){g.scrollToTop()}),r(window).scroll(function(){g.scroll()})});