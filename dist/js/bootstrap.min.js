...
var custom=function(a){a(document).ready(function(){var t=function(a,t,e){var i=a.outerHeight(),o=e.offset().top;t.scrollTop()>=o?(e.height(i),a.addClass("affix")):(a.removeClass("affix"),e.height("auto"))};a('[data-toggle="affix"]').each(function(){var e=a(this),i=a("<div></div>");e.before(i),a(window).on("scroll resize",function(){t(e,a(this),i)}),t(e,a(window),i)}),a(".navbar-nav a").click(function(){window.innerWidth<768&&a(".navbar-collapse").collapse("hide")}),a('a[href*="#"]').click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var t=a(this.hash);if(t=t.length?t:a("[name="+this.hash.slice(1)+"]"),t.length)return a("html, body").animate({scrollTop:t.offset().top-50},500),!1}})})}(jQuery);var customCV = function ($) {
