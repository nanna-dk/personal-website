...
var custom=function(e){e(document).ready(function(){function a(){e("#inputName").val(""),e("#inputEmail").val(""),e("#inputMessage").val(""),grecaptcha.reset()}var s=e("#goSearch"),t=e("#search"),n=e("#clearSearch"),r=e("#sendMail"),i=e("#contactform"),o=e(".feedback"),l=e("#navbarSideButton"),c=e("#navbarSide"),d=e(".overlay"),h=e("#menuItems").children().clone();c.prepend(h),l.click(function(){e(this).toggleClass("open"),c.addClass("reveal"),d.show()}),e("#navbarSide, .overlay, .nav-link").click(function(){c.removeClass("reveal"),l.toggleClass("open"),d.hide()});var u=function(e,a,s){var t=e.outerHeight(),n=s.offset().top;a.scrollTop()>=n?(s.height(t),e.addClass("affix")):(e.removeClass("affix"),s.height("auto"))};e('[data-toggle="affix"]').each(function(){var a=e(this),s=e("<div></div>");a.before(s),e(window).on("scroll resize",function(){u(a,e(this),s)}),u(a,e(window),s)}),e('a[href*="#"]').not(".accordion").click(function(){if(location.pathname.replace(/^\//,"")==this.pathname.replace(/^\//,"")&&location.hostname==this.hostname){var a=e(this.hash);if(a=a.length?a:e("[name="+this.hash.slice(1)+"]"),a.length)return e("html, body").animate({scrollTop:a.offset().top-50},500),!1}}),r.click(function(){var s=e(i).serialize(),t="../includes/mail/mail_ajax.php";e.ajax({type:"POST",url:t,beforeSend:function(){e(o).html('<div class="progress mb-4"><div class="progress-bar progress-bar-striped progress-bar-animated bg-info" role="progressbar" style="width: 75%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100"></div></div>')},data:s}).done(function(s){e(o).removeClass("alert alert-danger"),e(o).addClass("alert alert-success"),e(o).text(s),a()}).fail(function(a){e(o).removeClass("alert alert-success"),e(o).addClass("alert alert-danger"),""!==a.responseText?e(o).text(a.responseText):e(o).text("Der er sket en fejl. Beskeden er ikke blevet sendt.")})}),i.on("hidden.bs.modal",function(){o.text("").removeClass("alert alert-danger alert-success"),a()}),s.click(function(a){a.preventDefault();var s=e("#defaultAssignments"),n=e("#searchAssignments"),r="../includes/search/searchAssignments.php",i=t.val();return""!=i?(e.ajax({type:"POST",url:r,data:{search:i},success:function(e){s.hide(),n.html(e).show()},error:function(){n.html("Søgning kunne ikke udføres - prøv igen senere.").show()}}),!1):(n.html(""),void s.show())}),t.keypress(function(e){var a=e.keyCode?e.keyCode:e.which;13!=a&&10!=a||s.click()}),n.click(function(){t.val("").focus()}),e("#stats").on("hide.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","0")}),e("#stats").on("show.bs.collapse",function(){e(this).find(".card-header").css("border-bottom","1px solid rgba(0,0,0,0.125)")})})}(jQuery);